                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="text-right">
                                ...
                                <a href="/coa/create" class="btn btn-primary">
                                    <i class="fa-solid fa-plus"></i> Add COA
                                </a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                                ...
                                <tbody>
                                    @foreach ($coa as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <form class="d-inline" action="/coa/{{ $item->id }}/edit" method="GET">
                                                    <button type="submit" class="btn btn-success btn-sm mr-1">
                                                        <i class="fa-solid fa-pen"></i> Edit
                                                    </button>
                                                </form>
                                                <form class="d-inline" action="/coa/{{ $item->id }}" method="POST">
                                                    @csrf
                                                    @method('delete')
